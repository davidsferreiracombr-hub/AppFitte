...
export default function OlhoNoOlhoPage() {
  return (
    <AppLayout>
      <div className="flex-1 bg-black text-green-400">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <header className="text-center mb-16 pt-16">
              ...
              <p className="mt-6 text-lg md:text-xl text-green-400/70 max-w-3xl mx-auto">
            ...
            <main className="space-y-20">
              ...
              <section>
                ...
                <p className="text-green-400/70 text-center mb-10 max-w-3xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {whySellBenefits.map(card => (
                    <Card key={card.title} className="text-center p-6 bg-secondary/5 border-green-400/20 hover:border-green-400/50 hover:shadow-lg transition-all">
                        <div className="flex justify-center mb-4">
                            <div className="bg-green-400/10 p-3 rounded-full">
                                <card.icon className="h-8 w-8 text-green-400" />
                            </div>
                        </div>
                        <CardTitle className="text-xl mb-2 text-green-400/90">{card.title}</CardTitle>
                        <CardContent className="p-0 text-green-400/60 text-sm">
                            {card.description}
                        </CardContent>
                    </Card>
                  ))}
              ...
              <section className="bg-secondary/10 p-8 md:p-12 rounded-3xl border border-green-400/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-10 text-center">
                    <Card className="p-4 bg-black/20 border-green-400/20">
                        <CardTitle className="text-lg font-semibold text-green-400/90 mb-2">Rapport Inicial</CardTitle>
                        <CardContent className="p-0 text-sm text-green-400/60">Cumprimente com cordialidade, apresente-se e crie um ambiente acolhedor.</CardContent>
                    </Card>
                    <Card className="p-4 bg-black/20 border-green-400/20">
                        <CardTitle className="text-lg font-semibold text-green-400/90 mb-2">Perguntas Estratégicas</CardTitle>
                        <CardContent className="p-0 text-sm text-green-400/60">"É para uma celebração especial? Você tem alguma restrição alimentar?"</CardContent>
                    </Card>
                    <Card className="p-4 bg-black/20 border-green-400/20">
                        <CardTitle className="text-lg font-semibold text-green-400/90 mb-2">Técnica SPIN</CardTitle>
                        <CardContent className="p-0 text-sm text-green-400/60">Situação, Problema, Implicação e Necessidade para descobrir desejos profundos.</CardContent>
                    </Card>
                    <Card className="p-4 bg-black/20 border-green-400/20">
                        <CardTitle className="text-lg font-semibold text-green-400/90 mb-2">Recomendação Personalizada</CardTitle>
                        <CardContent className="p-0 text-sm text-green-400/60">Sugira produtos que atendam perfeitamente às necessidades identificadas.</CardContent>
                    </Card>
                </div>
                <div className="bg-green-400/10 border-l-4 border-green-400 p-5 rounded-r-lg text-center">
                    <p className="font-semibold text-green-400/90">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                    {mentalTriggers.map(trigger => (
                        <div key={trigger.title} className="flex flex-col items-center text-center">
                            <div className="bg-black/30 p-3 rounded-full mb-3 shadow-sm border border-green-400/10">
                                <trigger.icon className="h-7 w-7 text-green-400" />
                            </div>
                            <h3 className="font-semibold text-lg text-green-400/90">{trigger.title}</h3>
                            <p className="text-green-400/60 text-sm italic">{trigger.description}</p>
                        </div>
                    ))}
                </div>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <Card className="p-6 bg-secondary/5 border-green-400/20">
                        <CardHeader className="p-0 mb-4">
                            <CardTitle className="text-green-400/90">Destaque Diferenciais Únicos</CardTitle>
                        </CardHeader>
                        <CardContent className="p-0 text-green-400/60 text-sm">
                     ...
                     <Card className="p-6 bg-secondary/5 border-green-400/20">
                        <CardHeader className="p-0 mb-4">
                            <CardTitle className="text-green-400/90">Conte a História do Produto</CardTitle>
                        </CardHeader>
                        <CardContent className="p-0 text-green-400/60 text-sm">
              ...
              <section className="bg-secondary/10 p-8 md:p-12 rounded-3xl border border-green-400/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <div className="flex gap-4 items-start">
                        ...
                        <div>
                            <h3 className="font-semibold text-lg text-green-400/90">Sorriso Genuíno e Contato Visual</h3>
                            <p className="text-green-400/60 text-sm">Um sorriso autêntico ativa confiança. Contato visual demonstra interesse genuíno e cria empatia.</p>
                        </div>
                    </div>
                     <div className="flex gap-4 items-start">
                        <UserCheck className="h-8 w-8 text-green-400 flex-shrink-0 mt-1" />
                        <div>
                            <h3 className="font-semibold text-lg text-green-400/90">Postura Ereta e Aberta</h3>
                            <p className="text-green-400/60 text-sm">Mantenha-se ereto com ombros para trás, evitando braços cruzados. Transmite confiança e profissionalismo.</p>
                        </div>
                    </div>
                     <div className="flex gap-4 items-start">
                        <Hand className="h-8 w-8 text-green-400 flex-shrink-0 mt-1" />
                        <div>
                            <h3 className="font-semibold text-lg text-green-400/90">Gestos Expressivos com as Mãos</h3>
                            <p className="text-green-400/60 text-sm">Use as mãos para mostrar o produto, enfatizando textura, tamanho e qualidade. Reforça sua mensagem verbal.</p>
                        </div>
                    </div>
                     <div className="flex gap-4 items-start">
                        <ArrowRight className="h-8 w-8 text-green-400 flex-shrink-0 mt-1" />
                        <div>
                            <h3 className="font-semibold text-lg text-green-400/90">Inclinação Leve para Frente</h3>
                            <p className="text-green-400/60 text-sm">Ao falar ou ouvir, incline-se levemente. Este gesto demonstra engajamento e cria intimidade positiva.</p>
                        </div>
                    </div>
                </div>
                ...
                <p className="text-green-400/70 text-center mb-10 max-w-3xl mx-auto">
                 ...
                 <div className="space-y-6">
                    {objectionsStrategies.map(item => (
                        <Card key={item.title} className="bg-secondary/5 border-green-400/20">
                            <CardHeader>
                                <CardTitle className="text-xl text-green-400/90">{item.title}</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-3 text-sm">
                                <p><span className="font-semibold text-green-400">Estratégia:</span> <span className="text-green-400/70">{item.strategy}</span></p>
                                <p className="italic text-green-400/50"><span className="font-semibold text-green-400">Exemplo:</span> {item.example}</p>
                            </CardContent>
                        </Card>
                    ))}
                 </div>
              ...
              <section className="bg-secondary/10 p-8 md:p-12 rounded-3xl border border-green-400/10">
                <h2 className="text-3xl font-bold mb-8 text-center flex items-center justify-center gap-3"><Eye className="h-8 w-8" />Técnica 5: A importância da apresentação visual</h2>
                 <p className="text-green-400/70 text-center mb-10 max-w-3xl mx-auto">Comemos primeiro com os olhos! Uma apresentação impecável pode aumentar o valor percebido em até 40%. Não é desperdício, é estratégia.</p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="flex flex-col items-center text-center">
                        <div className="bg-black/30 p-3 rounded-full mb-3 shadow-sm border border-green-400/10">
                            <Package className="h-7 w-7 text-green-400" />
                        </div>
                        <h3 className="font-semibold text-lg text-green-400/90">Embalagens que Encantam</h3>
                        <p className="text-green-400/60 text-sm">Use caixas e laços que valorizem seus produtos e criem uma experiência de unboxing memorável.</p>
                    </div>
                     <div className="flex flex-col items-center text-center">
                        <div className="bg-black/30 p-3 rounded-full mb-3 shadow-sm border border-green-400/10">
                            <Palette className="h-7 w-7 text-green-400" />
                        </div>
                        <h3 className="font-semibold text-lg text-green-400/90">Cores Estratégicas</h3>
                        <p className="text-green-400/60 text-sm">Escolha paletas que harmonizem com seus doces e transmitam a mensagem certa: sofisticação, energia ou delicadeza.</p>
                    </div>
                     <div className="flex flex-col items-center text-center">
                        <div className="bg-black/30 p-3 rounded-full mb-3 shadow-sm border border-green-400/10">
                            <Gift className="h-7 w-7 text-green-400" />
                        </div>
                        <h3 className="font-semibold text-lg text-green-400/90">Detalhes que Fazem Diferença</h3>
                        <p className="text-green-400/60 text-sm">Adicione etiquetas personalizadas, cartões com mensagens ou pequenos brindes que surpreendam e criem conexão.</p>
                    </div>
                </div>
                <div className="mt-10 p-6 bg-secondary/5 border-l-4 border-green-400 italic text-center rounded-r-xl shadow-sm">
                    <p className="text-lg text-green-400/90">"A apresentação visual não é sobre enganar, mas sim fazer justiça à qualidade do seu produto e criar uma experiência completa."</p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {extraTips.map(tip => (
                         <Card key={tip.title} className="p-6 bg-secondary/5 border-green-400/20">
                            <CardHeader className="p-0 mb-3 flex-row items-center gap-3">
                                <tip.icon className="h-6 w-6 text-green-400" />
                                <CardTitle className="text-lg text-green-400/90">{tip.title}</CardTitle>
                            </CardHeader>
                            <CardContent className="p-0 text-sm text-green-400/60">
                                {tip.description}
                            </CardContent>
                        </Card>
                    ))}
              ...
              <section>
                ...
                <Card className="p-8 bg-secondary/5 border-green-400/20">
                    <CardTitle className="text-xl mb-6 text-center text-green-400/90">Seu Plano de Ação Imediato</CardTitle>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <h3 className="font-semibold text-lg text-green-400 mb-3">Esta Semana:</h3>
                            <ul className="space-y-2 text-sm text-green-400/70 list-disc list-inside">
                 ...
                 <div className="mt-10 p-6 bg-secondary/5 border-l-4 border-green-400 italic text-center rounded-r-xl shadow-sm">
                    <p className="text-lg text-green-400/90">"O sucesso não é sobre fazer produtos deliciosos — é sobre fazer cada cliente se sentir especial, valorizado e ansioso para voltar."</p>
                </div>
              </section>
