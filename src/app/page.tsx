        ...
        {featuredRecipe && (
          <div className="relative">
            <Link href={`/recipe/${featuredRecipe.slug}`} className="group block">
              <div className="relative overflow-hidden shadow-lg h-[450px] md:h-[500px] w-full">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center p-6 pt-24">
                    <h2 className="text-3xl md:text-6xl font-extrabold tracking-tight text-white mb-6">
                ...
                <Button
                    ...
                    variant="ghost"
                    size="icon"
                    className="absolute top-20 md:top-28 right-4 md:right-8 h-12 w-12 rounded-full text-white bg-white/10 backdrop-blur-sm hover:bg-white/20"
